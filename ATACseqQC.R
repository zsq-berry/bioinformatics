...
BiocManager::install(c('BSgenome.Mmusculus.UCSC.mm10', 
                       'TxDb.Mmusculus.UCSC.mm10.knownGene','phastCons60way.UCSC.mm10'))
library(ATACseqQC)
## input the bamFile from the ATACseqQC package 
bamfile <- "/media/shaoqizhu/easystore/Hdac-ATAC/rmdup/WT_D0_1_sorted_rmdup.bam"
...
outPath <- "/media/shaoqizhu/easystore/Hdac-ATAC/rmdup/splited"
